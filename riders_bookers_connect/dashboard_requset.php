...
<head>
 <title><?php include('header_title.php'); echo $header_tit; ?> - Welcome <?php echo htmlentities(htmlentities($_SESSION['fullname2p'], ENT_QUOTES, "UTF-8")); ?> 
</title>
...
$vehicle_type = strip_tags($_GET['data_type']);
include('settings.php');

$url =''.$tg_url.':9000/graph/'.$graph_db.'/vertices/'.$table_posts.'?sort=-timer&filter=vehicle_type="'."$vehicle_type".'" ';
...
// Haversine Formula of earths Curvature
