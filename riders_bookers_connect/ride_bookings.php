...
if(comdesc == ''){
alert('Bookings cannot be empty');
return false;
}

$('#loader').fadeIn(400).html('<br><span class="well" style="color:black"><img src="ajax-loader.gif">&nbsp;Please Wait, Your Ride Booking data is being Submitted to your Tigegraph Cloud Database</span>');             
        $.ajax({
            url: 'bookings.php',
            type: 'post',
...
&nbsp;<span id="<?php echo $postid; ?>"  style="color:#800000;cursor:pointer;" title="Book This Ride"   /></span>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<button style='display:none;' title="	Traveling Directional Map Locations" data-toggle="modal" data-target="#myModal_map" class="category_post1x btn_action_map" 
...
// Get bookings from vertex bookings in Tigergraph Database
$url =''.$tg_url.':9000/graph/'.$graph_db.'/vertices/'.$table_bookings.'?filter=postid="'."$postid".'" ';
...
echo "<div style='background:red;color:white;padding:10px;border:none'>No Booking on this Vehicle yet..</div>";
}
...
<input type='hidden' id="comdesc"  class=" form-control" style="color:black;"  value="Ride Booked Successfully">
...
<div id='loader'></div>
<h3>Ride Booking System</h3>

<button  id="<?php echo $postid; ?>" class="bookings pull-left readmore_btn"> <span style="font-size:26px;color:white;" class="fa fa-book" aria-hidden="true" 
title="Book this Ride Now"></span> Book this Ride Now</button>
</div>
<br><br>
